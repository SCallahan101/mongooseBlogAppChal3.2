...
// missed faker variable
// wrong chai i guess
const expect = chai.expect;

// determine where files in the end
...
function generateAuthorName() {
  const authors = {firstName: ['Tom', 'John', 'Mary', 'Julie', 'Jane', 'Kevin'], lastName: ["Smith"]} ;
  ...
  describe('GET endpoint', function() {
    it('it should return all existing blog posts', function() {
      ...
      .then(function(_res) {
        ...
        // maybe delete expect down below here?
